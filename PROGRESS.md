...
**Следующий шаг (этап 11 из PLAN.md раздел 8):** гиперпараметры — эксперимент по temperature/top_p с экспериментальным обоснованием (закрывает ТЗ 2.4; выбор LLM уже фактически обоснован A/B в этапе 10).
