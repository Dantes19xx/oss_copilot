...
export const UI = {
  en: {
    ...
    hasContributing: "CONTRIBUTING guide",
    noContributing: "No CONTRIBUTING guide",
    archivedLabel: "Archived",
    updatedLabel: "Updated",
    fitLabel: "Fit",
    issuesShown: "Showing {shown} of {total} good first issues",
    noIssues: "No open good-first-issues right now.",
    issuesRepoLabel: "Selected repository",
    approve: "Approve",
    merge: "Approve & merge",
    reject: "Reject",
    examplesLabel: "Try:",
    ...
    kickerIssues: "Good first issues",
  ...
  ru: {
    ...
    starsLabel: "Звёзды",
    goodFirstIssuesLabel: "good first issues",
    openIssuesLabel: "открытых issues",
    hasContributing: "Есть CONTRIBUTING",
    noContributing: "Нет CONTRIBUTING",
    archivedLabel: "В архиве",
    updatedLabel: "Обновлён",
    fitLabel: "Оценка",
    issuesShown: "Показано {shown} из {total} good first issues",
    noIssues: "Открытых good-first-issues сейчас нет.",
    issuesRepoLabel: "Выбранный репозиторий",
    approve: "Одобрить",
